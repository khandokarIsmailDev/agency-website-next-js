"use client"
//use client ditei hobe. coz onClick attribute use korsi. naile error show korbe
            ...
            <div className="nav z-10 relative ">
                <div className="container w-3/4 mx-auto h-16 lg:h-28 pb-1 flex justify-between items-center ">
                    ...
                    <div className="nav-menu lg:w-3/4 2xl:w-2/3">
                        <button
                            id="navHamburg"
                            className="duration-500 text-4xl lg:hidden pt-2 lg:pt-0 focus:outline-none  "
                            onClick={Menu}
                        >
                            <IonIcon
                                name="menu-outline"
                        ...
                        >
                            ...
                            <li className=" pb-5 p-1.5 lg:pb-0   ">
                                <a
                                    href="#"
                                    className="border-2 border-[#20B15A] px-5 py-2 rounded-lg hover:bg-[#20B15A] hover:text-white duration-500 transition-all"
                                >
                                    Login
                                </a>
                            </li>
                            <li className="pb-5 p-1.5 lg:pb-0  ">
                                <a
                                    href="#"
                                    className="border-2 bg-[#20B15A] text-white px-5 py-2 rounded-lg hover:bg-white hover:text-[#20B15A] hover:border-2 border-[#20B15A] transition-all duration-500"
                                >
                                    Register
                                </a>
                            </li>

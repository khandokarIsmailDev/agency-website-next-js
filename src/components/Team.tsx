            ...
            <div className="team ">
                <div className="container w-5/6 mx-auto">
                    ...
                    <div className="team-member grid grid-cols-1 lg:grid-cols-3 gap-8 ">
                        <div className="team-member w-full transition-all duration-500 hover:-translate-y-12 hover:shadow-2xl hover:shadow-gray-400 border-[1px] border-gray-100 rounded-2xl shadow-lg shadow-500/50 ">
                            <div className="relative">
                                <img
                                    src="/image/hero/hero1.png"
